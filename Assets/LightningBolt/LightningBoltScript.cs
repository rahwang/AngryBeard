...
namespace DigitalRuby.LightningBolt
{
    ...
    public class LightningBoltScript : MonoBehaviour
    {
        ...
        {
            Vector3 start, end;
            EndPosition = GameObject.FindGameObjectWithTag("Lightning").transform.position;
            StartPosition = GameObject.Find("GameManager").GetComponent<GameManager>().spell_hit_pos;
